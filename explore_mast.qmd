...
total_first_treatments_lact <- only_first_treatments %>%
...
retreatment_rates <- left_join(retreatments_lact, total_first_treatments_lact, by = "lact_group") %>%
  mutate(
...
#reset only_first_treatments to be safe
only_first_treatments <- first_treatment_data %>%
  filter(date_event == first_treatment_date)

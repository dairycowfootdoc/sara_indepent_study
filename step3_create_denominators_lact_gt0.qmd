...
date_start_deno <- "2025-02-12"
date_end_deno <- "2025-02-12"


# create data set
deno_dim <- fxn_create_deno(label = "2024") |> 
  fxn_dim_cat(num_categories = 13)  

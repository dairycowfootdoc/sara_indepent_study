...
all_periods <- expand.grid(id_animal_lact = unique(animals_repro$id_animal_lact), 
                           period_start_date = periods) %>%
  mutate(
    period_end_date = period_start_date + 20,  # Assign 21-day period
    period_number = match(period_start_date, periods)  # Assign period number
  )

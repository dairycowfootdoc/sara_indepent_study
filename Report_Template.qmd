...
date_start = date_start-365

periods <- rev(seq(to = date_start, from = date_end, by = "-21 days"))
...
# GC this is what screws things up.   The part I commented 2x out is what is setting lots of cows to 1.
# animals_repro_3 <- animals_repro_2 %>%
#   mutate(
...
# this accomplises same as above but with no mistakes
# but there are duplicates in things like ABORT, BRED PREG occur in same time period for example 5970
...
# already dates so not needed

# animals_repro_4 <- animals_repro_gc %>%
#   mutate(
...
# I don't think this is needed anymore based on previous code
...
# this is risky if col names aren't the same
